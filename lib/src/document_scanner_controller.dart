...
class DocumentScannerController {
  ...
  Stream<FilterType> get currentFilterTypeStream {
    return _appBloc.stream.transform(
      StreamTransformer.fromHandlers(
  ...
  FilterType get currentFilterType => _appBloc.state.currentFilterType;

  AppPages get currentPage => _appBloc.state.currentPage;

  AppState get state => _appBloc.state;
